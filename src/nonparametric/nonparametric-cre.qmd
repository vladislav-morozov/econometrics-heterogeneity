--- 
description: "Learn how index restrictions (Altonji-Matzkin) extend causal identification beyond stayers in panel data with unobserved heterogeneity (Lecture Notes)"
...
# Beyond Stayers Using Index Restrictions {#sec-nonparametric-cre}

::: {.callout-note appearance="simple" icon=false}

## Summary and Learning Outcomes

This section discusses how to extend identification beyond stayers using index restrictions.

By the end of this section, you should be able to: 

- Broadly understand index (CRE) restrictions.
- Use a one-dimensional index restriction to identify average marginal effects for non-stayers in model ([-@eq-nonparametric-model-full-nonsep]).
