...
This section  explains how heterogeneity bias distorts identification of causal marginal effects in nonparametric panel data models when treatments are endogenous.

By the end of this section, you should

- Understand why marginal effects cannot generally be identified from average outcomes in the presence of treatment endogeneity.
- Derive the decomposition of conditional expectations into structural and bias components.
- Recognize conditions under which heterogeneity bias disappears and causal effects become identifiable.
:::
