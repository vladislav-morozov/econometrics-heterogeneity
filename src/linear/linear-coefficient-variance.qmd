...
Previously, we focused on estimating the average coefficient vector $\E[\bbeta_i]$ in our model ([-@eq-random_intercept]):
$$
...
Naturally, moments of $\bbeta_i$ may be easily obtained the full distribution of $\bbeta_i$. This distribution is our maximal object of interest, and we now turn towards its identification.
