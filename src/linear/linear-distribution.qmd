...
If $\bX_i$ is continuously distributed, it instead necessary estimate the characteristic functions using techniques such as kernel regression. @Evdokimov2010 studies such the construction of such conditional deconvolution estimators and investigates their asymptotic properties. Inference may be conducted using the results of @Kato2021RobustInferenceDeconvolutiona. 
