...
2. Next section: we generalize the arguments to a setting with (conditional) unconfoundedness, where independence may hold only conditionally on some variables $W_i$.
